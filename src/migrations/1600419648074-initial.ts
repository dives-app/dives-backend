...
export class initial1600419648074 implements MigrationInterface {
  name = "initial1600419648074";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "budget_membership" ("id" SERIAL NOT NULL, "accessLevel" integer NOT NULL, "userId" uuid, "budgetId" uuid, CONSTRAINT "PK_f5ea7260aa256a8773f97e3b417" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "cycle_transaction" ADD CONSTRAINT "FK_9991d231bce5e0547022f3b2054" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "budget_membership" ADD CONSTRAINT "FK_1566b71ab838d920cfc9b00c46f" FOREIGN KEY ("budgetId") REFERENCES "budget"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "account" ADD CONSTRAINT "FK_72719f338bfbe9aa98f4439d2b4" FOREIGN KEY ("ownerId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "cycle_transaction" DROP CONSTRAINT "FK_9991d231bce5e0547022f3b2054"`
    );
    await queryRunner.query(
